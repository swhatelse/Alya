...
*** BOAST Kernel declaration
        #+BEGIN_SRC ruby :tangle /tmp/KSplitOss.rb
...
**** Frame to generate the kernel                                 :Technical:
       ...
       #+END_SRC
**** First nest
        #+BEGIN_SRC ruby :tangle /tmp/KSplitOssRef_v1.rb
          first_nest = <<EOF
           if( ndime == 2 ) then
...
**** Frame to generate the kernel                                 :Technical:
       ...
       #+END_SRC
**** First nest 
         #+BEGIN_SRC ruby :tangle /tmp/KSplitOssRef_v2.rb
            nests[0] = <<EOF
...
*** Getting kernel parameters
        ...
        #+END_SRC
*** Getting subroutine parameters                                :deprecated:
        #+BEGIN_SRC ruby :tangle /tmp/alya.rb
