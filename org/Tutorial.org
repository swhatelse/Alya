                ...
                opn for_inode
                  opn for_idime
                    ...
                    opn for_jnode
                      pr exp_fact1
                      if@unroll then
                        pr for_jdime.call(dim).unroll, &block_elauu_1
                      else
                        pr for_jdime.call(dim), &block_elauu_1
                      end
                    close for_jnode
                    pr If(@fvins_nsi == 2.0){
                      pr exp_fact1_2
                      opn for_jnode
                        if @unroll then
                          pr for_jdime.call(dim).unroll, &block_elauu_2
                        else
                          pr for_jdime.call(dim), &block_elauu_2
                        end
                      close for_jnode
                    }
                  close for_idime
