...
class Experiment
  ...
  def self.run
    ...
    nests.each{|n|
      k_orig_params = {:vector_length => vector_size, :preprocessor => false, :nests => [n]}
      k_boast_params = {:vector_length => vector_size, :nests => [n], :unroll => false}
      ...
      nest_name = ":nest#{n}"
      stats_boast[eval nest_name] = []
      stats_ref[eval nest_name] = []
      ...
      100.times{|i|
        ...
        stats_ref[eval nest_name][i] = k_orig.run(@@pnode,@@pgaus,@@gpden,@@gpvis,@@gppor,@@gpsp1,@@gpsp2,@@gpvol,@@gpsha,@@gpcar,@@gpadv,
        ...
        stats_boast[eval nest_name][i] = k_boast.run(@@pnode,@@pgaus,@@gpden,@@gpvis,@@gppor,@@gpsp1,@@gpsp2,@@gpvol,@@gpsha,@@gpcar,@@gpadv,
